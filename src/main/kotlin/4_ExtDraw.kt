...
fun main() = application {
    ...
    program {
        ...
        val atExt = mutableListOf<ColorBuffer>()
        ...
        extend(ScreenRecorder().apply {
            frameRate = 30
            outputFile = "video/scene_${sourceTarget}_experiment_${blur}.mov"
        ...
        extend {
            ...
            val maskImage =loadImage("data/frames/MASK${sourceTarget}/mask${frame}.jpg")
            val rgbImage = loadImage("data/frames/RGB${sourceTarget}/rgb${frame}.jpg")
            val extImage = loadImage("data/frames/EXTERNALSHOT/${4000+frame}.jpg")
...
//                    blur.apply( cbBackList.get( index), canvas)
                        ...
                        //vec2 uv = (c_screenPosition - vec2( 0.0, (cos(((p_count*0.5)-p_seconds*0.1)))*50.0)) / textSize;
                        ...
                        """.trimIndent()
                                parameter("texture", atExt.get( (index+frame) % atExt.size))
